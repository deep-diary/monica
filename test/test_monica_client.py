...
async def main():
    ...
    async with MonicaClient(monica_token, monica_base_url) as client:
        ...
        print("=" * 50)
        vaults_data = await client.get_vaults()
        ...
        contacts_data = await client.contacts.list(vault_id=vault_id, limit=25, page=1)
        ...
        if new_contact:
            ...
            if contact_url:
                ...
                if contact_id:
                    ...
                    delete_result = await client.contacts.delete(vault_id, contact_id)
                    if delete_result:
                        print("\n删除联系人成功:")
        ...
        if contacts_data:
            ...
            if contacts:
                ...
                search_results = await client.contacts.search(vault_id, search_name)
                if search_results:
                    print("\n搜索结果:")
