...
def main():
    # 配置信息
    monica_token = "DcmeEW7FLD4ly8EkhOI9ZBjfKXxre3eTq5m6hTJq1ef2f025"
    monica_base_url = "http://192.168.31.125:8080"
    vault_id = "019b5d45-c87f-714b-a475-c1d01d9c359d"  # DeepDiary vault
    ...
    contacts_data = client.contacts.list(vault_id=vault_id, limit=5, page=1)
    ...
    create_result = client.quick_facts.create(
        vault_id=vault_id,
    ...
    if create_result:
        ...
        if quick_fact_id:
            ...
            get_result = client.quick_facts.get(
                vault_id=vault_id,
                contact_id=contact_id,
                template_id=template_id
            )
            ...
            update_result = client.quick_facts.update(
                vault_id=vault_id,
                contact_id=contact_id,
                template_id=template_id,
            ...
            delete_result = client.quick_facts.delete(
                vault_id=vault_id,
                contact_id=contact_id,
                template_id=template_id,
                quick_fact_id=quick_fact_id
    ...
    for template_id, template_name in templates.items():
        ...
        result = client.quick_facts.create(
            vault_id=vault_id,
            contact_id=contact_id,
            template_id=template_id,
